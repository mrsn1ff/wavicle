...
$stmt = $pdo->prepare('SELECT * FROM catalog_categories WHERE id=?');
$stmt->execute([$id]);
$cat = $stmt->fetch();
if (!$cat) {
    header('Location: index.php');
...
<div class="wv-page-header">
    <div>
        <h1>Edit Category</h1>
        <div class="wv-breadcrumb"><a href="../../index.php">Dashboard</a> / <a href="index.php?type=<?php echo $data['type']; ?>">Categories</a> / Edit</div>
    </div>
...
<div class="wv-card">
    <div class="wv-card__header"><span class="wv-card__title">Edit: <?php echo e($cat['name']); ?></span></div>
