...
$adminActivePage = 'cat_mgr';
include __DIR__ . '/../../includes/header.php';
?>
<div class="wv-page-header">
    <div>
        <h1>Add Category</h1>
        <div class="wv-breadcrumb"><a href="../../index.php">Dashboard</a> / <a href="index.php?type=<?php echo $type; ?>">Categories</a> / Add</div>
    </div>
...
<div class="wv-card">
    <div class="wv-card__header"><span class="wv-card__title">Category Details</span></div>
        ...
        <form method="POST" enctype="multipart/form-data" onsubmit="syncCK()">
            <div class="wv-form-row">
                <div class="wv-form-group"><label class="wv-label">Type <span class="wv-required">*</span></label>
                    <select name="type" class="wv-select">
                        <option value="product" <?php echo $data['type'] === 'product' ? 'selected' : ''; ?>>Product Category</option>
                        <option value="service" <?php echo $data['type'] === 'service' ? 'selected' : ''; ?>>Service Category</option>
                    </select>
                </div>
            ...
            <div class="wv-form-row">
                <div class="wv-form-group"><label class="wv-label">Category Name <span class="wv-required">*</span></label>
                    <input type="text" name="name" id="cat_name" class="wv-input" value="<?php echo e($data['name']); ?>" placeholder="e.g. Swimming Pool Ladders" required oninput="slug.value=makeSlug(this.value)" />
                </div>
                <div class="wv-form-group"><label class="wv-label">Slug</label>
                    ...
                    <small style="color:#6c757d;font-size:11px;margin-top:4px;display:block;">Auto-generated from name. Used in URL.</small>
                </div>
            </div>
            ...
            <div class="wv-form-row">
                <div class="wv-form-group"><label class="wv-label">Category Image</label>
                    ...
                    <small style="color:#6c757d;font-size:11px;margin-top:6px;display:block;">Recommended: 1080×1080px (square)</small>
                </div>
