...
$adminPageTitle='Edit Service'; $adminActivePage='cat_services';
...
<div class="wv-page-header">
    <div><h1>Edit Service</h1><div class="wv-breadcrumb"><a href="../../index.php">Dashboard</a> / <a href="index.php?cat=<?php echo $item['category_id'];?>">Services</a> / Edit</div></div>
