...
$imgSrc      = !empty($blogImg)
    ? htmlspecialchars($base . '/' . ltrim($blogImg, '/'), ENT_QUOTES, 'UTF-8')
    : $fallbackImg;
            ...
            <?php foreach ($sections as $sec): ?>
                <div class="bi-sec-block">
                    <?php if (!empty($sec['heading'])): ?>
                        <h3 class="bi-sec-heading"><?php echo htmlspecialchars($sec['heading'], ENT_QUOTES, 'UTF-8'); ?></h3>
                    <?php endif; ?>
