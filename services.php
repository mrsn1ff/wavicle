...
$pageTitle  = 'Services | Wavicle';
$activePage = 'pages';
$fallback   = $base . '/assets/images/courses/course-1-1.jpg';

$categories = $pdo->query(
    "SELECT * FROM catalog_categories WHERE type='service' AND status=1 ORDER BY sort_order ASC, id ASC"
...
<div class="pc-hero">
    <div class="container" style="position:relative;z-index:1;text-align:center;">
        <div style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#59b5e8;margin-bottom:12px;font-family:'Montserrat',sans-serif;">Our Services</div>
        <h1 style="font-family:'Montserrat',sans-serif;font-size:clamp(26px,5vw,44px);font-weight:800;color:#fff;text-transform:uppercase;margin-bottom:0;">Service Categories</h1>
    </div>
</div>
    ...
    <div class="container">
        <?php if ($categories): ?>
            <div class="pc-grid">
                <?php foreach ($categories as $cat):
                    ...
                    $url = $base . '/services/' . urlencode($cat['slug']);
                ?>
        ...
        <?php else: ?>
            <div style="text-align:center;padding:80px 0;color:#6c757d;">
                <i class="fa fa-concierge-bell" style="font-size:52px;color:#dee2e6;display:block;margin-bottom:16px;"></i>
                <div style="font-family:'Montserrat',sans-serif;font-weight:700;font-size:16px;">No service categories yet.</div>
